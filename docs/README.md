...
Welcome to the GDF (Go Dotfiles) documentation.

## Quick Navigation

### For Users

- [Getting Started](user-guide/getting-started.md) - First-time setup
- [Tutorial](user-guide/tutorial.md) - End-to-end hands-on tutorial
- [Profiles](user-guide/profiles.md) - Managing profiles
- [Apps](user-guide/apps.md) - Working with app bundles
- [Aliases](user-guide/aliases.md) - Shell aliases and functions
- [Syncing](user-guide/syncing.md) - Git sync workflows
