...
type Config struct {
	...
	// ShellIntegration configures shell-specific behavior generated by GDF.
	ShellIntegration *ShellIntegrationConfig `yaml:"shell_integration,omitempty"`

	// UI configures human-readable CLI presentation defaults.
...
// ShellIntegrationConfig controls generated shell integration behavior.
type ShellIntegrationConfig struct {
	// AutoReloadEnabled enables prompt-hook based reload checks for generated init scripts.
	AutoReloadEnabled *bool `yaml:"auto_reload_enabled,omitempty"`
}

// UIConfig controls interactive CLI presentation defaults.
type UIConfig struct {
	// Color controls ANSI color mode: auto, always, never.
	Color string `yaml:"color,omitempty"`

	// ColorSectionHeadings enables colorized section headings in human-readable output.
	ColorSectionHeadings *bool `yaml:"color_section_headings,omitempty"`

	// HighlightKeyValues enables colorized "key: value" key highlighting.
	HighlightKeyValues *bool `yaml:"highlight_key_values,omitempty"`
}
...
// AutoReloadEnabledDefault returns the effective shell auto-reload setting.
func (s *ShellIntegrationConfig) AutoReloadEnabledDefault() bool {
	if s == nil || s.AutoReloadEnabled == nil {
		return false
	}
	return *s.AutoReloadEnabled
}

// ColorDefault returns the effective UI color mode.
func (u *UIConfig) ColorDefault() string {
	if u == nil || u.Color == "" {
		return "auto"
	}
	return u.Color
...
// ColorSectionHeadingsDefault returns the effective section heading color setting.
func (u *UIConfig) ColorSectionHeadingsDefault() bool {
	if u == nil || u.ColorSectionHeadings == nil {
		return true
	}
	return *u.ColorSectionHeadings
}

// HighlightKeyValuesDefault returns the effective key highlighting setting.
func (u *UIConfig) HighlightKeyValuesDefault() bool {
	if u == nil || u.HighlightKeyValues == nil {
		return true
	}
	return *u.HighlightKeyValues
}
